...
namespace Main
{
    public class TechshopMenu
    {
        ...
        static void ViewAllCustomers()
        {
            ...
            var customers = customersdao.GetAllCusto(); // Corrected method name
        ...
        static void ViewCustomerDetails()
        {
            ...
            CustomersDao customersdao = new CustomersDao();
            var customer = customersdao.GetCustomerDetails(customerId);
        ...
        static void UpdateCustomerInformation()
        {
            ...
            if (customer != null)
            {
                ...
                bool isUpdated = customersdao.UpdateCustomerInfo(customer);
                if (isUpdated)
                {
        ...
        static void CalculateTotalOrdersForCustomer()
        {
            ...
            CustomersDao customersdao = new CustomersDao();
            int totalOrders = customersdao.CalculateTotalOrders(customerId);
        ...
        static void ViewProductDetails()
        {
            ...
            ProductsDao productService = new ProductsDao();
        ...
        static void UpdateProductInformation()
        {
            ...
            var product = productsdao.GetProductDetails(productId);
            ...
            if (product != null)
            {
                ...
                bool isUpdated = productsdao.UpdateProductInfo(product);
                if (isUpdated)
                {
        ...
        static void CheckProductStock()
        {
            ...
            ProductsDao productsdao = new ProductsDao();
            bool inStock = productsdao.IsProductInStock(productId);
        ...
        static void CalculateTotalOrderAmount()
        {
            ...
            decimal totalAmount = ordersdao.CalculateTotalAmount(orderId);
        ...
        static void UpdateOrderStatus()
        {
            ...
            OrdersDao ordersdao = new OrdersDao();
            bool isUpdated = ordersdao.UpdateOrderStatus(orderId, status);
        ...
        static void CancelOrder()
        {
            ...
            OrdersDao ordersdao = new OrdersDao();
            bool isCancelled = ordersdao.CancelOrder(orderId);
